...
class Coordinateur extends Entite {
  ...
  public void body() {
	...
	envoyer_message("AppliCliente", reponse);
      ...
      System.out.println("8Fin de l'entite " + get_name());
    }
  }
}
...
class Entite extends Sim_entity {
  ...
  protected Message attendre_message() throws Exception {      
    ...
    if (m == null) {
      System.out.println("EXCEPTION ATTENDRE MSG");
...
/*
  Le simulateur
*/
public class Exemple2a extends Anim_applet {
  ...
  public void anim_layout() {
    ...
    Participant p1 = new Participant("Participant1", 370, 10, "base1", true);
